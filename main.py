...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        # создание кнопки для удаления записи
    ...
    # функция для обновления (изменение) данных
    ...
    # функция для поиска записи по (name - по ФИО!)
    ...
    # функция для вызова дочернего окна
    def open_dialog(self):
        Child()

    # функция для вызова окна для изменения данных
    def open_update_dialog(self):
        Update()

    # функция для вызова окна для поиска
...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        # создание кнопки для закрытия дочернего окна
